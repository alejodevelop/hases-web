	...
	const clientes = [
		{
			...
			logo: '/reservas-cana-brava.webp',
			testimonial: 'Acompanamiento constante para mantener zonas comunes limpias y operativas.'
		},
		{
			name: 'Condominio Campestre Altos de la Pradera',
			logo: '/altos-pradera.webp',
			testimonial: 'Servicio coordinado con continuidad en rutinas de aseo y mantenimiento.'
		},
		{
			name: 'Condominio Encenillo Reservado',
			logo: '/encenillo-reservado.webp',
			testimonial: 'Atencion oportuna y cumplimiento en actividades programadas de la copropiedad.'
		},
		{
			name: 'Conjunto Turipana',
			logo: '/turipana-neiva.webp',
			testimonial:
				'Respaldo operativo para conservar orden, limpieza y buena presentacion de espacios.'
		}
	];
